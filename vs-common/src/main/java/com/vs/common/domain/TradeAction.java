...
public class TradeAction implements Comparable<TradeAction> {
    ...
    public TradeAction(Strategies strategy, TradeDirection direction, Stock stock, LocalDate analysisDate, LocalDate tradeDate) {
        this(strategy, direction, stock, analysisDate, tradeDate, -1);
    }

    public TradeAction(Strategies strategy, TradeDirection direction, Stock stock, LocalDate analysisDate, LocalDate tradeDate, double tradePrice) {
    ...
    public static List<TradeAction> merge(final List<TradeAction> actions) {
        Map<LocalDate, TradeAction> actionMap = Maps.newConcurrentMap();
