...
public class Transaction implements Comparable<Transaction> {
    ...
    public Transaction(LocalDate date, TradeDirection direction, Stock stock, double price, long positions) {
        this(date, direction, stock, Strategies.NONE, price, positions);
    }

    public Transaction(LocalDate date, TradeDirection direction, Stock stock, Strategies strategy, double price,
                       long positions) {
        this.date = date;
    ...
    public int compareTo(Transaction o) {
        ...
        return this.getDate().compareTo(o.getDate()) >= 0 ? 1 : -1;
    }
